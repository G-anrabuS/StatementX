...
class BankExtractorService:
    def __init__(self):
        # Initializes the client natively leveraging the environment's API Key
        self.client = genai.Client()

    async def execute_semantic_parse(self, document_bytes: bytes) -> StatementExtractionResponse:
